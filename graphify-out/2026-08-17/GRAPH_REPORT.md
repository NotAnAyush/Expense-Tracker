...
## Corpus Check
- 144 files · ~122,942 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2001 nodes · 2723 edges · 145 communities (125 shown, 20 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.72)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4f3ecd59`
...
- [[_COMMUNITY_analytics.test.js|analytics.test.js]]
...
- [[_COMMUNITY_serverpackage.json|server/package.json]]
...
- [[_COMMUNITY_categoryRoutes.js|categoryRoutes.js]]
- [[_COMMUNITY_auth.js|auth.js]]
- [[_COMMUNITY_aiController.js|aiController.js]]
- [[_COMMUNITY_exportRoutes.js|exportRoutes.js]]
- [[_COMMUNITY_validate.js|validate.js]]
- [[_COMMUNITY_Codebase Standards & Architecture Constraints|Codebase Standards & Architecture Constraints]]
- [[_COMMUNITY_Backend Architecture & API Specs|Backend Architecture & API Specs]]
- [[_COMMUNITY_Graphify Knowledge Graph Rule|Graphify Knowledge Graph Rule]]
- [[_COMMUNITY_vite.config.js|vite.config.js]]
- [[_COMMUNITY_Pinterest Style UI & Masonry Design System|Pinterest Style UI & Masonry Design System]]
- [[_COMMUNITY_Design System Master Tokens & Styling Guide|Design System Master Tokens & Styling Guide]]
- [[_COMMUNITY_joi|joi]]
...
- [[_COMMUNITY_patterns.test.js|patterns.test.js]]
...
- [[_COMMUNITY_pinterestREADME|pinterest/README.md]]
...
5. `apiFetch()` - 21 edges
6. `supertest` - 21 edges
7. `mongodb-memory-server` - 21 edges
8. `protect()` - 19 edges
9. `🚀 Richy Rich — Strategic Feature Roadmap & Productivity Innovations` - 19 edges
10. `express` - 19 edges
...
Cohesion: 0.08
Nodes (51): apiFetch(), getLocalDateString(), dependencies, framer-motion, lucide-react, react, react-dom, recharts (+43 more)
...
### Community 2 - "App.jsx"
Cohesion: 0.05
Nodes (24): ApiResponse, { Debt }, { DebtAmortizationEngine }, DebtController, Expense, ApiResponse, asyncHandler, { BadRequestError } (+16 more)
...
Cohesion: 0.05
Nodes (39): closeDatabase(), connectDB(), mongoose, mongooseOptions, aiRoutes, analyticsRoutes, app, auditLogger (+31 more)
...
Cohesion: 0.06
Nodes (31): express, jwt, User, express, { protect }, router, {
  suggestCategory,
  getMonthlySummaryAI,
...
Cohesion: 0.09
Nodes (21): asyncHandler, { BadRequestError, ConflictError }, Category, asyncHandler, Expense, { NotFoundError, BadRequestError }, {
  AppError,
  ValidationError,
  BadRequestError,
  NotFoundError,
...
}, BadRequestError (+13 more)

### Community 11 - "server/package.json"
Cohesion: 0.06
Nodes (30): closeDatabase(), connectDB(), mongoose, mongooseOptions, aiRoutes, analyticsRoutes, app, auditLogger (+22 more)
...
Cohesion: 0.06
Nodes (32): bcryptjs, compression, cors, dotenv, express-rate-limit, express-validator, @google/generative-ai, helmet (+24 more)

### Community 15 - "goalRoutes.js"
Cohesion: 0.07
Nodes (20): FireSimulatorEngine, ApiResponse, Expense, { FireSimulatorEngine }, Goal, Income, SimulationController, app (+12 more)
...
Cohesion: 0.1
Nodes (15): asyncHandler, { BadRequestError, UnauthorizedError }, bcrypt, Budget, Category, crypto, Expense, Goal (+7 more)
...
### Community 32 - "joi"
Cohesion: 0.12
Nodes (12): expenseSchema, mongoose, AnalyticsService, ContextBuilder, AnalyticsService, Expense, ToolRegistry, Budget (+4 more)

### Community 33 - "🔑 Complete REST API Endpoints Reference"
Cohesion: 0.12
Nodes (11): AuditLog, auditLogger(), REDACTED_FIELDS, protect(), cleanupTimer, idempotency(), idempotencyCache, requestLogger() (+3 more)
...
Cohesion: 0.12
Nodes (11): AIService, asyncHandler, { BadRequestError }, metadata, UnifiedAIClient, User, AnalyticsService, asyncHandler (+3 more)

### Community 37 - "Community 37"
Cohesion: 0.12
Nodes (15): jest, nodemon, devDependencies, jest, nodemon, supertest, supertest, app (+7 more)
...
Cohesion: 0.14
Nodes (11): asyncHandler, Budget, cleanCat, { NotFoundError, BadRequestError }, asyncHandler, cAmt, Goal, { NotFoundError, BadRequestError } (+3 more)
...
Cohesion: 0.15
Nodes (11): budgetSchema, mongoose, mongoose, refreshTokenSchema, mongoose, app, Budget, { MongoMemoryServer } (+3 more)
...
Cohesion: 0.15
Nodes (7): AIService, asyncHandler, { BadRequestError }, AnalyticsService, asyncHandler, asyncHandler, Expense

### Community 58 - "Community 58"
Cohesion: 0.15
Nodes (10): asyncHandler, Budget, { NotFoundError, BadRequestError }, budgetSchema, mongoose, app, Budget, { MongoMemoryServer } (+2 more)
...
Cohesion: 0.17
Nodes (10): AUDIT_TTL_DAYS, auditLogSchema, mongoose, app, AuditLog, Expense, { MongoMemoryServer }, mongoose (+2 more)
...
Cohesion: 0.29
Nodes (6): app, { MongoMemoryServer }, mongoose, mongoUri, request, User
...
Cohesion: 0.33
Nodes (5): express, { getAnalyticsOverview, getCashFlow }, { getAnalyticsOverview, getCashFlow, getFinancialHealth }, { protect }, router
...
## Knowledge Gaps
- **1210 isolated node(s):** `VALID_TABS`, `DEFAULT_MESSAGE`, `TAX_SECTIONS`, `DEFAULT_INCOME_CATEGORIES`, `AuthContext` (+1205 more)
...
- **Why does `mongoose` connect `Community 48` to `App.jsx`, `client/package.json`, `expenseRoutes.js`, `goalRoutes.js`, `recurringRoutes.js`, `⚡ Enterprise AI/ML Production Improvement Blueprint`, `categoryRoutes.js`, `auth.js`, `errors.js`, `Community 37`, `recurringController.js`, `Community 46`, `Community 47`, `Community 62`, `Community 63`, `Community 68`, `Community 69`, `Community 70`, `Community 76`, `Community 77`, `Community 78`, `Community 84`, `Community 89`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `express` connect `budgetRoutes.js` to `Community 65`, `Community 74`, `server/package.json`, `Community 50`, `setup-git-hooks.cjs`, `validate.js`, `Community 59`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `keywords` connect `setup-git-hooks.cjs` to `budgetRoutes.js`, `scripts`?**
