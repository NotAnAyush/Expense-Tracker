...
const expenseSchema = new mongoose.Schema({
  ...
  source: {
    type: String,
    enum: ['manual', 'recurring', 'ai_suggested', 'import', 'upi_sync', 'ecommerce_sync', 'account_aggregator'],
    default: 'manual',
  },
  motive: {
    type: String,
    enum: ['Need', 'Want', 'Investment', 'Emergency', 'Work', 'Impulse', 'Social', 'Other'],
    default: 'Need',
  },
  motiveInsight: {
    type: String,
  ...
  ecommercePlatform: {
    type: String,
    enum: ['amazon', 'flipkart', 'blinkit', 'zepto', 'swiggy', 'zomato', 'myntra', 'bigbasket', 'instamart', 'other', 'none'],
    default: 'none',
  },
  upiDetails: {
  ...
  receiptDetails: {
    ...
    tokenNumber: { type: String, trim: true, default: '' },
